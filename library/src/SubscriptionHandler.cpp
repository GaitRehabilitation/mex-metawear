...
void SubscriptionHandler::mexSubscribeGyro(std::shared_ptr<matlab::engine::MATLABEngine> engine,void *context,  ParameterWrapper& outputs, ParameterWrapper& inputs) {
    ...
    switch (getSubscriptionMode(engine,type.toAscii())) {
        case StreamType::STREAMING: {
            ...
            outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(gyro_signal, StreamType::STREAMING, "gyro")));
        }
        break;
        case StreamType::LOG: {
            auto gyro_signal = mbl_mw_gyro_bmi160_get_rotation_data_signal(board);
            outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(gyro_signal, StreamType::LOG, "gyro")));
        }
        break;
    }
}
...
void SubscriptionHandler::mexSubscribeAcc(std::shared_ptr<matlab::engine::MATLABEngine> engine,void *context,  ParameterWrapper& outputs, ParameterWrapper& inputs){
    ...
    switch (getSubscriptionMode(engine,type.toAscii())) {
        case StreamType::STREAMING: {
            ...
            outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(acc_signal, StreamType::STREAMING, "acc")));
        }
        break;
        case StreamType::LOG: {
            auto acc_signal = mbl_mw_acc_get_acceleration_data_signal(board);
            outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(acc_signal, StreamType::LOG, "acc")));
        }
        break;
    }
}
...
void SubscriptionHandler::mexSubscribeFusion(std::shared_ptr<matlab::engine::MATLABEngine> engine,void *context,  ParameterWrapper& outputs, ParameterWrapper& inputs) {
    ...
    if (type.toAscii() == "CORRECTED_ACC") {
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(corrected_acc,getSubscriptionMode(engine,mode.toAscii()),"sensor_fuson_data_corrected_acc")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(corrected_gyro,getSubscriptionMode(engine,mode.toAscii()),"fusion_corrected_gyro")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(corrected_mag,getSubscriptionMode(engine,mode.toAscii()),"fusion_corrected_mag")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(quaternion_signal,getSubscriptionMode(engine,mode.toAscii()),"fusion_quaternion")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(euler_angle,getSubscriptionMode(engine,mode.toAscii()),"fusion_euler_angle")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(gravity_signal,getSubscriptionMode(engine,mode.toAscii()),"fusion_gravity")));
        ...
        outputs[0] = factory.createCharArray(wrapper->registerHandler(new StreamHandler(linear_acceleration_signal,getSubscriptionMode(engine,mode.toAscii()),"fusion_linear_acc")));
    } else {
